    ...
    <>
      <StyledTextSection ref={textSectionTriggerRef}>
        <p className="text__intro">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris eleifend porta mauris, sit amet mollis metus molestie id. Suspendisse suscipit placerat lectus, viverra molestie lorem dignissim id
        </p>
      </StyledTextSection>
